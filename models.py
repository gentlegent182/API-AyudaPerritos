...
class Cliente(db.Model):
    ...
    rut = db.Column(db.Number(11), nullable=False)
    porcentaje = db.Column(db.number(3), nullable=False)
    ...
    fono = db.Column(db.number(3), nullable=False)
    correo = db.Column(db.String(250), nullable=False)
    estado = db.Column(db.Char(1), nullable=False)
    comuna_id = db.Column(db.number(3), nullable=False)
...
class Venta(db.Model):
    ...
    descuento = db.Column(db.number(3), nullable=True)
    subtotal = db.Column(db.number(3), nullable=False)
    iva = db.Column(db.number(3), nullable=False)
    total = db.Column(db.number(3), nullable=False)
    estado = db.Column(db.char(1), nullable=False)
    cliente_id = db.Column(db.number(3), nullable=False)
    vendedor_id = db.Column(db.number(3), nullable=False)
    despacho = db.Column(db.number(3), nullable=False)
...
class Producto(db.Model):
    ...
    nombre = db.Column(db.String(250), nullable=False)
    valor_venta = db.Column(db.Number(9999999), nullable=False)
    stock = db.Column(db.Number(999), nullable=False)
...
class Detalle(db.Model):
    ...
    cantidad = db.Column(db.Number(999), nullable=False)
    valor = db.Column(db.Number(9999999), nullable=False)
    descuento = db.Column(db.Number(999), nullable=False)
    estado = db.Column(db.Char(1), nullable=False)
    venta_id = db.Column(db.Number(999), nullable=False)
    producto_id = db.Column(db.Number(999), nullable=False)
    def serialize(self):
        return {
...
class Donacion(db.Model):
    ...
    cliente_id = db.Column(db.number(9999999), nullable=False)
...
class Comuna(db.Model):
    ...
    nombre = db.Column(db.String(250), nullable=False)
    fecha_inicio = db.Column(db.Number(999), nullable=False)
...
class Vendedor(db.Model):
    ...
    dv = db.Column(db.Char(1), nullable=False)
    primer_nombre = db.Column(db.String(250), nullable=False)
    segundo_nombre = db.Column(db.String(250), nullable=True)
    apellido_paterno = db.Column(db.String(250), nullable=False)
    apellido_materno = db.Column(db.String(250), nullable=True)
    direccion = db.Column(db.String(250), nullable=False)
    fono = db.Column(db.Number(9), nullable=False)
    correo = db.Column(db.String(250), nullable=False)
    estado = db.Column(db.Char(1), nullable=False)
    comuna_id = db.Column(db.Number(999), nullable=False)
...
class Despacho(db.Model):
    ...
    esta_despacho = db.Column(db.SmallInt(9), nullable=False)
    venta_id = db.Column(db.Number(9999999), nullable=False)
    comuna_id = db.Column(db.Number(9999999), nullable=False)
